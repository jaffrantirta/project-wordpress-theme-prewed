 ...
 * Template untuk menampilkan semua artikel blog (alternative to avoid /blog slug conflict)
 */
get_header(); ?>

<div class="all-posts-page" style="padding-top: 100px; padding-bottom: 80px; background: var(--light-bg);">
    <div class="container">
        <!-- Page Header -->
        <div class="row mb-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Pagination -->
                <?php if ($blog_posts->have_posts() && $blog_posts->max_num_pages > 1) : ?>
                    <div class="row mt-5">
                        <div class="col-12">
